...
imdb_data_file = '../data/raw_data/imdb/data1.json'

imdb_output_full_data_filename = '../data/processed/imdb_alldata.tsv'
imdb_output_train_filename = '../data/processed/imdb_train.tsv'
imdb_output_dev_filename = '../data/processed/imdb_dev.tsv'
imdb_output_test_filename = '../data/processed/imdb_test.tsv'
